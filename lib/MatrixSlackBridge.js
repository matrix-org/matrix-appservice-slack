...
MatrixSlackBridge.prototype.initialiseMetrics = function() {
    ...
    metrics.addGauge({
        ...
        refresh: (gauge) => {
            ...
            this._rooms.forEach((room) => {
                remote_counts.bump(now - room.getRemoteATime());
                matrix_counts.bump(now - room.getMatrixATime());
            });
    ...
    metrics.addGauge({
        ...
        refresh: (gauge) => {
            ...
            count("remote", this._ghostsByUserId);
...
MatrixSlackBridge.prototype.getOAuth2 = function() {
    return this._oauth2;
};
...
MatrixSlackBridge.prototype.getOrCreateMatrixUser = function(id) {
...
MatrixSlackBridge.prototype.drainAndLeaveMatrixRoom = function(roomId) {
...
MatrixSlackBridge.prototype.listRoomsFor = function(intent, state) {
