...
SlackHookHandler.prototype.handle = function(url, params) {
    ...
    var method = result[2] || "post";

    var room = this.bridge.getRoomByInboundId(inbound_id);
    ...
    if (method === "post") {
        ...
        console.log("TODO: Incoming hit to "+method+" to room " + room.getInboundId());
    }
};
...
SlackHookHandler.prototype.handlePost = function(room, params) {
    ...
    var token = bridge.getTeamToken(params.team_domain);
    if (!token) {
