...
BridgedRoom.prototype.getStatus = function() {
    ...
    if (!this._inbound_id && !this._slack_token) {
        return "pending-params";
    }
...
BridgedRoom.prototype.addMatrixRoomId = function(room_id) {
    if (this._matrix_room_ids.indexOf(room_id) === -1) {
        if (this._inbound_id && this._matrix_room_ids.length) {
...
BridgedRoom.prototype.toEntry = function() {
    this._dirty = false;
    var id = this._slack_channel_id || "INTEG-" + this._inbound_id;
    var matrix_id;
    if (this._inbound_id) {
        ...
        matrix_id = this._matrix_room_ids[0];
    }
    var entry = {
        id: id,
        remote_id: this._slack_channel_id || this._inbound_id,
        matrix_id: matrix_id,
        remote: {
