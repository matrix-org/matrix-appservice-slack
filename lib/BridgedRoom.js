...
BridgedRoom.prototype.onMatrixMessage = async function(message) {
    ...
    const stripped_message = this.stripMatrixReplyFallback(message);
    log.error("aa", stripped_message);
    const body = await substitutions.matrixToSlack(stripped_message, this._main);
